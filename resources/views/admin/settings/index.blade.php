                    ...
                    <tbody>
                        @foreach ($all as $item)
                            <tr>
                                ...
                                <td>{{ $item->mobile }}</td>
                                <td>
                                    <img src="{{ url('admin/setting/images/'.$item->image) }}" style="width:70px;height:50px;border-radius:5px;"/>
                                </td>
                                <td>{{ $item->address }}</td>
                                <td style="width: 22%;">
                                    
                                    <button class="label label-primary label-rounded label-icon edit" data-toggle="modal" data-target="#modal" loop_id="{{ $item->id }}">
                                        <span><i class=" icon-pencil"></i></span>
                                    </button>
                    
                                    <button class="label label-danger label-rounded label-icon delete" loop_id="{{ $item->id }}">
    ...
    <script>
            ...
            $(document).ready(function(){
                ...
                $(document).on("click", "table tbody tr .edit", function(e){
                    ...
                    $.ajax({
                        ...
                        success: function(res){
                            ...
                            $("#modal form #setting_image").css('display' , 'block').attr("src" , "{{ url('admin/setting/images') }}"+"/"+res[0].image);
                        },
                    });
                ...
                $(document).on("click" , "table .delete" ,function(e){
                    ...
                    swal({
                        title: "{{ trans('app.Are You Sure Of Delete') }} !",
