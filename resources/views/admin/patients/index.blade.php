...
@section('content')
        ...
        <div class="page-header page-header-default">
            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">{{ trans('app.Patients') }}</h4>
                </div>
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb" style="margin: 10px;">
                    ...
                    <li class="active">{{ trans('app.Patients') }}</li>
                </ul>
        ...
        <div class="content">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title">{{ trans('app.All Patients') }}</h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                    ...
                    <tbody>
                        @foreach ($all as $item)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ url('admin/images/patients/'.$item->image) }}" style="width:50px;height:50px;border-radius:50%;"/>
                                </td>
                                <td>
                                    @if($item->status == 1)
                                        {{ trans('app.active') }}
    ...
    @include('admin/patients/preview')
    ...
    <script>
            ...
            $(document).ready(function(){
                ...
                $(document).on("click" , "table .preview" , function(){
                    ...
                    $.ajax({
                        url: "{{ url('admin/show_patients') }}"+'/'+loop_id,
                        type: 'get',
                        success: function(res){                            
                            $("#image img").attr("src" , "{{ url('admin/images/patients') }}"+"/"+res[0].image);
                ...
                $("#add_new").click(function(){
                    ...
                    $("#modal .modal-footer #save").click(function(e){
                        ...
                        error: function(res){
                            ...
                            if(res.responseJSON.errors.blood_group){
                                $("form #errors-blood_group").css('display' , 'block').text(res.responseJSON.errors.blood_group);
                            }else{
                ...
                $(document).on("click", "table tbody tr .edit", function(e){
                    ...
                    $.ajax({
                        url: "{{ url('admin/edit_patients') }}"+'/'+loop_id,
                        type: 'get',
                        success: function(res){
                            console.log(res);
                            ...
                            $("#modal form .image_hidden").css("display" , "block").attr("src" , "{{ url('admin/images/patients') }}"+"/"+res[0].image);
                            if(res[0].gender == 1)
                    ...
                    $(document).on("click" , "#modal .modal-footer #update" ,function(e){
                        ...
                        $.ajax({
                            url: "{{ url('admin/update_patients') }}"+'/'+loop_id,
                            type: 'POST',
                            data: $('#modal form').serialize(),
                            success: function(res){
                                console.log(res);
                ...
                $(document).on("click" , "table .delete" ,function(e){
                    ...
                    swal({
                      ...
                      .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                url: "{{ url('admin/delete_patients') }}"+'/'+loop_id,
                                type: "get",
                                success: function(){
                                    location.reload();
