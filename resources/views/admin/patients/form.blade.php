        ...
        <div class="modal-content">
            ...
            <form class="m-form m-form--label-align-left- m-form--state-" id="form" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-4" id="blood_group">
                                <label>{{ trans('app.blood_group') }}</label>
                                <i class=" icon-star-full2 require_input"></i>
                                <select name="blood_group"  class="bootstrap-select" data-live-search="true" data-width="100%">
                                ...
                                <bold class="text-danger" id="errors-blood_group" style="display: none;"></bold>
                            </div>
